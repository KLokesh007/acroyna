...
const MobileApp: React.FC = () => {
    return (
        <div className="mobileapp-container">
            <h1 className="mobileapp-heading">Crafting intuitive and <br />
                user-centric mobile app<br />
                designs that seamlessly<br />
                merge functionality,<br />
                aesthetics, and innovation</h1>
            ...
            <div className="mobileapp-content">
                <div className="md: flex h-90 w-full items-center justify-center lg:mr-20 lg:w-1/2">
                    <LottieAnimation
                        animationPath="/lottie/mobileapp.json" // Animation for another use
                        loop={true}
                        autoplay={true}
                    />
                </div>
            ...
            <div className="mobileapp-footer">
                <h2>Our Role</h2>
                <p>Our role in mobile app design is to provide a tailored approach that focuses on understanding
                ...
                <p>
                    <i>
                        All/Development/Maintenance/E-Commerce/DevOps    </i>
                </p>
            </div>
        </div>
    );
